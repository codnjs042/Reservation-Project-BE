...
public enum ErrorCode {
    ...
    RESERVATION_UNAVAILABLE_TIME(HttpStatus.BAD_REQUEST, "RESERVATION-001", "해당 시간은 예약 불가합니다."),
    RESERVATION_FULL_TIME(HttpStatus.CONFLICT, "RESERVATION-002", "해당 시간은 예약이 마감되었습니다."),
